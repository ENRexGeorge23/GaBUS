...
class MapPickerRoadScreen extends StatefulWidget {
  static const routeName = 'map-picker-road-screen';

  @override
  _MapPickerRoadScreenState createState() => _MapPickerRoadScreenState();
}

class _MapPickerRoadScreenState extends State<MapPickerRoadScreen>
            ...
            Positioned(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.of(context).pushNamed(PayNowScreen.routeName);
                },
